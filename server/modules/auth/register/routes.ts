...
router.post('/', controller.validateFields, controller.doesUsernameExist, controller.createUser, (req: Request, res: Response) => res.status(200).json({ message: 'Registration successful.' }));
